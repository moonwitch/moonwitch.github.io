...
***Never work on `master`; always use a branch to work on features and issues.***
Why this matters? Because `master` is your holy grail, your production.
...
Because branching effectively creates a copy of your local version of `master`, it's best to make sure your local copy is up-to-date.
...
2. Get the most recent version of `master`.
...
Once you've completed working in your branch and you're ready to merge it into `master`, go on and raise a Merge Request. You can opt to do it via the provided link or using push options as I've said.

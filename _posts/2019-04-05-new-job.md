...
Turns out that studying JavaScript was fun, as was studying Ruby and (ELK)[http://elastic.co] I am back to using Linux, albeit under Windows 10 using (Pengwin)[https://www.pengwin.dev/]. Even this blog/site is completely done under Linux, just posting is occasionally done with [Prose.io] because it's handy to post while enroute. 
